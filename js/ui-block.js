    ...
    function insert(dic) {
        ...
        function header(selector) {
            ...
            i18n.run($(selector)
                ...
                .html(
                    "<div>" +
                    "    <a href=" + arr[0] + " data-i18n=header/list></a>" +
                    "    <a href=" + arr[1] + " data-i18n=header/register></a>" +
                    "    <a href=" + arr[2] + " data-i18n=header/unregister></a>" +
                    "    <a href=" + arr[3] + " data-i18n=header/transfer></a>" +
                    "</div>" +
                    "<hr>"));
        }
